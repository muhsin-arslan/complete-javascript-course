...
class App {
  ...
  _newWorkout(e) {
    ...
    //STEP: If workout running, create running object
    if (type === 'running') {
    ...
    //STEP: If workout cycling, create cycling object
    if (type === 'cycling') {
    ...
    //STEP: Add new object to workouts array
    ...
    //STEP: Hide form and clear inputs
    this._hideForm();

    //STEP: Set local storage to all workouts
  ...
  _moveToPopup(e) {
    ...
    //NOTE: Using the public interface
    // workout.click();
  }
